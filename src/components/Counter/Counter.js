...
export const add = (counter, setCounter, ...cbs) => setCounter(new Counter(counter).add(...cbs))

export const sub = (counter, setCounter, ...cbs) => setCounter(new Counter(counter).sub(...cbs))