...
// generatea fade transition, enjoy it with ReactCSSTransitionGroup
...
export function slide(enterPosition: Position = { x: 0, y: -30 }, leavePosition: Position = enterPosition, enterTimeout = defaultEnterTimeout, leaveTimeout = defaultLeaveTimeout) {
